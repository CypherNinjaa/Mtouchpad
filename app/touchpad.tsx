...
export default function TouchpadScreen() {
	...
	const { leftHandMode, darkMode } = useSettingsStore();
	...
	return (
		...
		>
			{/* <GeometricBg /> not sure if it receives generic props or not, wait let's just leave it */}
			<GeometricBg />
			...
			<View style={styles.container}>
					...
					<View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
						...
						<Pressable onPress={() => router.push("/settings")}>
							<Feather
								name="settings"
								size={20}
								color={darkMode ? "#94A3B8" : colors.mutedFg}
							/>
						</Pressable>
					</View>
				</View>
				...
				<View style={styles.touchAreaContainer}>
					...
					<View
						style={[
							styles.keyboardTextBox,
							!isKeyboardActive && styles.hiddenInputContainer,
						]}
					>
				...
				>
					...
					<Pressable
						style={[
							...
							{
								backgroundColor:
									isKeyboardActive ? colors.accent
									: darkMode ? "#1E293B"
									: colors.card,
								borderColor: darkMode ? "#475569" : colors.foreground,
							},
					...
					<View style={styles.mediaContainer}>
						<Pressable
							style={[
								...
								{
									backgroundColor: darkMode ? "#1E293B" : colors.card,
									borderColor: darkMode ? "#475569" : colors.border,
								},
							]}
							onPress={() => handleMediaPress("prev")}
						>
							<Feather
								name="skip-back"
								size={18}
						...
						<Pressable
							...
							onPress={() => handleMediaPress("play_pause")}
						>
							<Feather
								name="play"
								size={18}
						...
						<Pressable
							...
							onPress={() => handleMediaPress("vol_down")}
						>
							<Feather
								name="volume-1"
								size={18}
						...
						<Pressable
							...
							onPress={() => handleMediaPress("vol_up")}
						>
							<Feather
								name="volume-2"
								size={18}
